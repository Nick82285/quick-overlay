...
IUSE="debug dnscrypt dnstap +ecdsa ecs gost +http2 +quic python redis selinux static-libs systemd test +tfo threads"
...
DEPEND="
    ...
    quic? ( net-libs/ngtcp2:=[${MULTILIB_USEDEP}] )
"
BDEPEND="
	virtual/pkgconfig
...
multilib_src_configure() {
	local myeconfargs=(
        ...
        $(multilib_native_usex quic --with-libngtcp2="${ESYSROOT}/usr" --without-libngtcp2 )
